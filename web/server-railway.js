...
async function initializeDatabase() {
  try {
    if (dbType === 'postgresql') {
      ...
      // Crear índices
      await db.query('CREATE INDEX IF NOT EXISTS idx_sale_orders_store_id ON sale_orders(store_id)');
      await db.query('CREATE INDEX IF NOT EXISTS idx_sale_orders_date ON sale_orders(order_date)');
      ...
      // Crear índices
      db.prepare('CREATE INDEX IF NOT EXISTS idx_sale_orders_store_id ON sale_orders(store_id)').run();
      db.prepare('CREATE INDEX IF NOT EXISTS idx_sale_orders_date ON sale_orders(order_date)').run();
